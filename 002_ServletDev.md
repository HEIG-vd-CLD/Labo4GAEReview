...
- We provide a sample Servlet that shows how to use the Datastore API
  to write an entity. See file `DatastoreWriteSimple.java` at the end
  of this document. You can download it, and **copy-paste** (Not drag and drop) on the servlet directory of your project on IntelliJ.
...
- Copy a screenshot of the local and the App Engine console with the
  Datastore Viewer.